...
/**
 * Servlet implementation class Delete_Feedback
 */
@WebServlet("/Delete_Feedback")
public class Delete_Feedback extends HttpServlet {
	...
	{
		String[]idArray=request.getParameterValues("chkdelete");
